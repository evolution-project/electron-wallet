...
if (process.env.PROD) {
    ...
    global.__evolution_bin = path.join(__dirname, "..", "bin").replace(/\\/g, "\\\\")
} else {
    global.__evolution_bin = path.join(process.cwd(), "bin").replace(/\\/g, "\\\\")
}
