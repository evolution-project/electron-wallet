...
export class Backend {
    ...
    init() {
        ...
        this.remotes = [{host: "us.evolutionproject.space", port:52922},
                        {host: "solo.evolutionproject.space", port:52922},
                        {host: "eu.evolutionproject.space", port:52922},
                        {host: "asia.evolutionproject.space", port:52922}]


        if(os.platform() == "win32") {
	    this.config_dir = "C:\\ProgramData\\evolution";
	    this.wallet_dir = `${os.homedir()}\\Documents\\Evolution`
        } else {
            this.config_dir = path.join(os.homedir(), ".evolution")
            this.wallet_dir = path.join(os.homedir(), "Evolution")
        }
        ...
        this.config_file = path.join(this.config_dir, "gui", "config.json")
                        ...
                        const daemons = {
                            mainnet: {
                                ...daemon,
                                remote_host: "us.evolutionproject.space",
                                remote_port: 52922
                            },
                            stagenet: {
                                ...daemon,
