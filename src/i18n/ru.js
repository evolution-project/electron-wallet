export default {
    ...
    menuItems: {
        ...
        exit: "Закрыть Кошелек evolution",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "Не найден файл evolutiond, используется удаленная нода"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        evolutionUnlockedBalance: "Разблокированый баланс",
        evolutionUnlockedShort: "Разблокировано",
