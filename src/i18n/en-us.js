export default {
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "evolutiond not found, using remote node"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        evolutionBalance: "Balance",
        evolutionExchangeBalance: "Balance",
        evolutionUnlockedBalance: "Unlocked balance",
        evolutionUnlockedShort: "Unlocked",
