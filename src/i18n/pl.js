export default {
    ...
    menuItems: {
        ...
        exit: "Wyjdź evolution GUI Wallet",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "evolutiond nie znaleziono, używam zdalnego węzła"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        evolutionUnlockedBalance: "Odblokowane saldo",
        evolutionUnlockedShort: "Odblokowane",
