export default {
    buttons: {
        ...
        copySignature: "COPIAZĂ SEMNATURĂ",
        createWallet: "CREAZĂ PORTOFEL",
        delete: "ȘTERGE",
        edit: "MODIFICĂ",
        export: "EXPORTĂ",
        generate: "GENEREAZĂ",
        import: "IMPORTĂ",
        importWallet: "IMPORTĂ PORTOFEL | IMPORTĂ PORTOFELE",
        next: "URMĂTORUL",
        openWallet: "DESCHIDE PORTOFEL",
        receive: "PRIMEȘTE",
        registerServiceNode: "INREGHISTREAZĂ SERVICE NODE",
        rescan: "RESCANEAZĂ",
        restoreWallet: "RESTAUREAZĂ PORTOFEL",
        save: "SALVEAZĂ",
        saveTxNotes: "SALVEAZĂ NOTĂ DE TRANZACȚIE",
        selectLocation: "SELECTEAZĂ LOCAȚIE",
        selectWalletFile: "ALEGEȚI FIȘIERUL PORTOFELULUI",
        send: "TRIMITE",
        sendCoins: "TRIMITE MONEDE",
        serviceNode: "SERVICE NODE",
        settings: "SETRĂI",
        showQRCode: "AFIȘAȚI CODUL QR",
        showTxDetails: "AFIȘEAZĂ DETALILE TRANZACȚIEI",
        stake: "STACHEAZĂ",
        sweepAll: "MĂTURĂ TOT",
        unlock: "DEBLOCAȚI",
        txHistory: "ISTORICUL TRANZACȚIILOR",
        viewOnExplorer: "VEZI IN EXPLORER",
        wallet: "PORTOFEL"
    },
    dialog: {
        // Generic buttons
        ...
        // Dialogs
        banPeer: {
            title: "Blochează Conexiunea",
            peerDetailsTitle: "Detalii Conexiune",
            message: "Setează cat timp va dura blocare in secunde. \n Acum durează 3600 = 1 oră.",
            ok: "Blochează Conexiunea"
        },
        copyAddress: {
            title: "Copiază Adresa",
            message: "Există un ID de plată asociat cu această adresă.\n Asigurați-vă că ati copiat ID-ul de plată separat."
        },
        copyPrivateKeys: {
            // Copy {seedWords/viewKey/spendKey}
            title: "Copiați {type}",
            message: "Aveți grijă către cine trimiteți cheile dvs. private, deoarece acestea vă controlează fondurile.",
            seedWords: "Cuvinte de siguranță",
            viewKey: "Clé d’affichage",
            spendKey: "Clé de dépenses"
        },
        deleteWallet: {
            title: "Ștergeți portofelul",
            message: "Sunteți absolut sigur că doriți să vă ștergeți portofelul? \ n Asigurați-vă că aveți backup făcut pentru cheile dvs. private. \n Acest proces nu este reversibil !",
            ok: "Șterge"
        },
        exit: {
            title: "Inchideți si ieșiți?",
            message: "Sigur doriți să ieșiți?",
            ok: "Da"
        },
        keyImages: {
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "evolutiond introuvable, utilisation du nœud distant"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        evolutionBalance: "Solde",
        evolutionExchangeBalance: "Solde",
        evolutionUnlockedBalance: "Solde débloqué",
        evolutionUnlockedShort: "Débloqué",
