export default {
    ...
    menuItems: {
        ...
        exit: "Ukončit Evolution GUI Peněženku",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "evolutiond nenalezeno, použít vzdálený node"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        evolutionBalance: "Zůstatek",
        evolutionUnlockedBalance: "Odemčený zůstatek",
        evolutionUnlockedShort: "Odemčeno",
        evolutionExchangeBalance: "Stavy na burzách",
