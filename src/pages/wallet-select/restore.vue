...
<q-page>
    <div class="q-mx-md">
        <EvolutionField class="q-mt-md" :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
        ...
        <EvolutionField class="q-mt-md" :label="$t('fieldLabels.mnemonicSeed')" :error="$v.wallet.seed.$error">
            <q-input
                v-model="wallet.seed"
        ...
        <div class="row items-end q-mt-md">
            <div class="col">
                <EvolutionField v-if="wallet.refresh_type=='date'" :label="$t('fieldLabels.restoreFromDate')">
                ...
                <EvolutionField v-else-if="wallet.refresh_type=='height'" :label="$t('fieldLabels.restoreFromBlockHeight')" :error="$v.wallet.refresh_start_height.$error">
        ...
        <EvolutionField class="q-mt-md" :label="$t('fieldLabels.password')">
            <q-input
        ...
        <EvolutionField class="q-mt-md" :label="$t('fieldLabels.confirmPassword')">
            <q-input
...
import EvolutionField from "components/evolution_field"
export default {
    data () {
        return {
            wallet: {
