...
<q-page>
    <div class="q-mx-md import-wallet">
        ...
        <EvolutionField :label="$t('fieldLabels.newWalletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
        ...
        <EvolutionField :label="$t('fieldLabels.walletFile')" disable-hover :error="$v.wallet.path.$error">
            <q-input
                v-model="wallet.path"
        ...
        <EvolutionField :label="$t('fieldLabels.password')">
            <q-input
        ...
        <EvolutionField :label="$t('fieldLabels.confirmPassword')">
            <q-input
