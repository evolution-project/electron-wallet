    ...
    <template v-else>
        <div class="q-pa-md">
            <div class="row gutter-md">
                ...
                <!-- Amount -->
                <div class="col-6">
                    <EvolutionField :label="$t('fieldLabels.amount')" :error="$v.newTx.amount.$error">
                ...
                <!-- Priority -->
                <div class="col-6">
                    <EvolutionField :label="$t('fieldLabels.priority')">
            ...
            <div class="col q-mt-sm">
                <EvolutionField :label="$t('fieldLabels.address')" :error="$v.newTx.address.$error">
            ...
            <!-- Payment ID -->
            <div class="col q-mt-sm">
                <EvolutionField :label="$t('fieldLabels.paymentId')" :error="$v.newTx.payment_id.$error" optional>
            ...
            <!-- Notes -->
            <div class="col q-mt-sm">
                <EvolutionField :label="$t('fieldLabels.notes')" optional>
            ...
            <div v-if="newTx.address_book.save">
                <EvolutionField :label="$t('fieldLabels.name')" optional>
                ...
                <EvolutionField class="q-mt-sm" :label="$t('fieldLabels.notes')" optional>
