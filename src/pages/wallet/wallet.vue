...
<q-page padding>
    ...
    <div class="row">
        ...
        <div class="infoBoxBalance">
            <div class="infoBox">
                <div class="infoBoxContent">
                    <q-item-tile label>{{ $t("strings.evolutionBalance") }}</q-item-tile>
                    <div class="value"><span><FormatEvolution :amount="info.balance" /></span></div>
                </div>
            </div>
        </div>
        ...
        <div class="infoBoxBalance">
            <div class="infoBox">
                <div class="infoBoxContent">
                    <q-item-tile label>{{ $t("strings.evolutionExchangeBalance") }}</q-item-tile>
        ...
        <div>
            <div class="infoBox">
                <div class="infoBoxContent">
                    <q-item-tile label>{{ $t("strings.evolutionUnlockedBalance") }}</q-item-tile>
                    <div class="value"><span><FormatEvolution :amount="info.unlocked_balance" /></span></div>
                </div>
            </div>
        </div>
